...
public class ProjectMaster {
    ...
    @ManyToOne
    @JoinColumn(name = "list_member_id")
    private ListMemberProject listMember;
    ...
    public ListMemberProject getListMember() {
        return listMember;
    }

    public void setListMember(ListMemberProject listMember) {
